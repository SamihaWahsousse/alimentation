            ...
            <section class="dataUser ">
                ...
                <div class="col">
                    <div class="doughnut">
                        ...
                        <div class="kcal"> <?php echo $sumCalories ?> kcal</div>
                    </div>
                </div>
                <div class="col text-center">
...
foreach ($tabFood as $food){?>
        ...
        <div class="text-center">
         ...
         Button trigger modal -->
            ...
            <div class="modal fade" id="modalAlertCalorie" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <h6>Vous avez dépasser le seuil des calories recommandés par jour!</h6>
                            <p> Vous avez consommé : <?php echo $sumCalories ?> Kcal</br>
                                Votre besoin calorique journalier: <?php echo $limitCaloriePerDay ?> Kcal
                            </p>
                        </div>
